 ...
 *
 * Ajoute également les boutons de scroll mobile de #subsite-navigation.
 *
 * Ce module s'exécute lui-même à l'import (effet de bord) : il est
 * partagé via @imiobe/plonetheme-smartweb-base et importé par chaque
 * thème, exactement comme le SCSS de base l'est via @import.
 */
(function () {
  console.log("nav-submenu.js chargé");
